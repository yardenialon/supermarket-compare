...
CATEGORIES = {
    "מוצרי חלב": ["חלב ושמנת", "יוגורט ומעדנים", "גבינות", "חמאה", "ביצים", "לבן ואשל"],
    "לחם ומאפה": ["לחם ולחמניות", "פיתות ולאפות", "מאפים מלוחים", "עוגות ומאפים מתוקים", "עוגיות וביסקוויטים"],
    ...
    "שימורים ומזון יבש": ["שימורים", "רטבים וממרחים", "תבלינים ועשבי תיבול", "שמנים וחומצים", "מרקים ואבקות"],
    ...
    "בריאות ותוספים": ["ויטמינים ותוספים", "מזון בריאות", "תרופות ללא מרשם"],
