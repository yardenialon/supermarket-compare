...
export const GUIDES: GuideInfo[] = [
  ...
  {
    slug: "saving-tips",
    title: "איך לחסוך בקניות בסופר: 12 טכניקות שעובדות",
    seoTitle: "איך לחסוך בקניות בסופר? 12 טכניקות מבוססות נתונים | Savy",
    description: "12 דרכים מוכחות לחסוך מאות שקלים בחודש על קניות הסופר — עם מספרים אמיתיים מנתוני המחירים של כל הרשתות בישראל.",
    emoji: "💰",
    targetQuery: "איך לחסוך בקניות בסופר",
    datePublished: "2026-07-20",
  },
  {
    slug: "baby-formula-prices",
    title: "תרכובות מזון לתינוקות — איפה הכי זול?",
    seoTitle: "מטרנה, סימילאק ונוטרילון — השוואת מחירים 2026 | Savy",
    description: "כמה עולות תרכובות מזון לתינוקות, איך משווים נכון (מחיר ל-100 גרם), ואיפה הכי זול לקנות — מחירים חיים מכל הרשתות.",
    emoji: "🍼",
    targetQuery: "מטרנה מחיר",
    datePublished: "2026-07-20",
  },
  {
    slug: "online-groceries-compare",
    title: "קניות סופר אונליין — איפה הכי משתלם?",
    seoTitle: "שופרסל אונליין או רמי לוי אונליין? השוואה מלאה | Savy",
    description: "השוואה בין שירותי הקניות אונליין של הרשתות הגדולות: מחירים, היצע ושיטת ההשוואה הנכונה לפני שמזמינים — עם כלי חינמי להשוואת הסל שלכם.",
    emoji: "🛍️",
    targetQuery: "שופרסל אונליין או רמי לוי אונליין",
    datePublished: "2026-07-20",
  },
  {
    slug: "family-food-budget",
    title: "כמה מוציאה משפחה בישראל על אוכל בחודש?",
    seoTitle: "כמה מוציאה משפחה על אוכל בחודש? הנתונים המלאים | Savy",
    description: "כמה עולה מזון למשפחה בישראל בחודש, איך אתם ביחס לממוצע, ואיפה מסתתר החיסכון — נתוני למ\"ס לצד מחירים חיים מהרשתות.",
    emoji: "👨‍👩‍👧‍👦",
    targetQuery: "כמה מוציאה משפחה על אוכל בחודש",
    datePublished: "2026-07-20",
  },
];
